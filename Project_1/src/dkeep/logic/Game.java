...
public class Game implements java.io.Serializable {
	 ...
	 * 
	 * @param b
	 *            The game board to be played.
	 * @param map
	 *            The container which has the information about the game
	 *            Entidade's.
	 */
	...
	/**
	 * Method that is responsible for making all the Ogres in the field map
	 * attacking and updating the game board.
	 * 
	 * @return
	 */
	public void attack() {
	...
	public char attackTest() {
		for (Entidade temp : getEntidades()) {
			if (temp instanceof Ogre) {
				return ((Ogre) temp).attack(board);
			}
		}
		return ' ';
	}
	...
	/**
	 * Method that is responsible for clearing the game board of all the Ogres'
	 * attacks.
	 */
	 ...
	 * 
	 * @return String data type that contains the game board separating each
	 *         line with new line characters.
	 */
	 ...
	 * 
	 * @return CellPosition data type whit the information of the Hero in the
	 *         game Board.
	 */
	 ...
	 * 
	 * @return int data type with -1 if game has not ended, 1 if game ended in
	 *         defeat, 0 if game ended in victory.
	 */
	 ...
	 * 
	 * @param map
	 *            Vector of Entidade's data type.
	 * @see Entidade
	 */
